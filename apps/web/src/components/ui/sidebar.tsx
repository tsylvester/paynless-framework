	...
	if (collapsible === "none") {
		return (
			<div
				data-slot="sidebar"
				className={cn(
					"bg-sidebar text-sidebar-foreground flex h-full w-(--sidebar-width) min-w-(200px) flex-col",
					className,
				)}
				{...props}
			>
	...
	return (
		...
		>
			...
			<div
				...
				className={cn(
					"fixed inset-y-0 z-10 hidden h-svh width-full transition-[left,right,width] duration-200 ease-linear md:flex",
					side === "left"
