...
describe('OrganizationSettingsCard', () => {
  ...
  it('should display the current organization name and visibility in the form', async () => {
    ...
    // Assert
    // Wait for the input value to be set by the useEffect hook using findBy
  ...
  // Test for Delete Button (Placeholder)
  it('should call console.log when delete button is clicked (placeholder behavior)', () => {
    ...
    // Assert
    expect(consoleSpy).toHaveBeenCalledWith('TODO: Open Delete Organization Dialog');
