...
const SubscriptionSuccessPage = lazy(() =>
	import("../pages/SubscriptionSuccess").then((module) => ({
...
const OrganizationHubPage = lazy(() =>
	import("../pages/OrganizationHubPage").then((module) => ({
		default: module.OrganizationHubPage,
	})),
);
const OrganizationFocusedViewPage = lazy(() =>
	import("../pages/OrganizationFocusedViewPage").then((module) => ({
		default: module.OrganizationFocusedViewPage,
	})),
);
const TransactionHistoryPage = lazy(() =>
	import("../pages/TransactionHistory").then((module) => ({
...
const DialecticProjectsPage = lazy(() =>
	import("../pages/DialecticProjectsPage").then((module) => ({
		default: module.DialecticProjectsPage,
	})),
);
const CreateDialecticProjectPage = lazy(() =>
	import("../pages/CreateDialecticProjectPage").then((module) => ({
		default: module.CreateDialecticProjectPage,
	})),
);
const DialecticProjectDetailsPage = lazy(() =>
	import("../pages/DialecticProjectDetailsPage").then((module) => ({
		default: module.DialecticProjectDetailsPage,
	})),
);
const DialecticSessionDetailsPage = lazy(() =>
	import("../pages/DialecticSessionDetailsPage").then((module) => ({
		default: module.DialecticSessionDetailsPage,
	})),
);
