  ...
  return (
    <Layout>
      <div className="py-6">
        ...
        <div className="mt-8 bg-red-100 dark:bg-red-900 border border-red-400 dark:border-red-700 text-red-700 dark:text-red-200 px-4 py-3 rounded relative mb-6" role="alert">
          <strong className="font-bold block text-lg">WARNING! WARNING! WARNING!</strong>
          <ul className="list-disc list-inside mt-2 space-y-1">
            <li>This framework works AS IS, but there are no warranties or guarantees, explicit or implied.</li>
            <li>All changes are AT YOUR OWN RISK! Our code works, but we can't fix YOUR code.</li>
            <li>Be very careful before letting AI Coding Assistants tamper with the Supabase Functions (<code>supabase/functions/</code>) or Shared Packages (<code>packages/</code>).</li>
            <li>Never let the frontend communicate directly with Supabase database/auth. Maintain the backend (Edge Function) -&gt; store -&gt; API Client -&gt; frontend layering.</li>
            <li>Be extremely careful with any changes to files in <code>packages/api-client</code> or <code>packages/store/</code>.</li>
            <li>The <code>apps/web</code> and <code>apps/desktop</code> frontends work, but <code>apps/android</code> and <code>apps/ios</code> aren't populated yet.</li>
          </ul>
        </div>

        <div className="mt-8 bg-blue-100 dark:bg-blue-900 border border-blue-400 dark:border-blue-700 text-blue-700 dark:text-blue-200 px-4 py-3 rounded relative mb-6" role="alert">
          <strong className="font-bold block text-lg">How to Effectively Use This Framework with AI Coding Assistants:</strong>
          <ul className="list-disc list-inside mt-2 space-y-1">
            <li>Read the <code className="text-xs">README.md</code> file thoroughly to understand this project's architecture, structure, and contents.</li>
            <li>Keep the <code className="text-xs">README.md</code> file in context for every AI coding prompt.</li>
            <li>Regularly remind the AI assistant to re-read the <code className="text-xs">README.md</code> file.</li>
            <li>Regularly ask the AI assistant to update the documentation (like the README) sections for database schema, file structure, and API endpoints when you make changes.</li>
            <li>Regularly ask the AI assistant if its proposed changes align with the architecture, structure, and patterns described in the <code className="text-xs">README.md</code> file.</li>
            <li>Ask the AI assistant to create detailed work plans and checklists for feature additions, including architecture considerations, deliverables, development steps, and testing requirements.</li>
            <li>Make the AI assistant follow the checklist, update its progress, and refer back to it frequently.</li>
            <li>Remind the AI assistant to use Test-Driven Development (TDD): Ask it to write unit tests based on your requirements *before* writing the feature code. Ensure the tests pass before accepting the code.</li>
          </ul>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ol className="list-decimal list-inside space-y-1 text-textSecondary">
                ...
                <li>Add Redirect for Client-Side Routing: 
                  <ul className="list-disc list-inside ml-4 mt-1">
              ...
              <ol className="list-decimal list-inside space-y-1 text-textSecondary">
                 ...
                 <li>Set up a Stripe Webhook endpoint:
                   <ul className="list-disc list-inside ml-4 mt-1">
                     ...
                     <li>The endpoint URL should be your deployed Supabase function URL for the webhook handler: <code>&lt;your-supabase-project-url&gt;/functions/v1/stripe-webhook</code></li>
