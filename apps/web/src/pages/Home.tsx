	...
	return (
		<div>
			<div className="w-full">
				<div className="w-full bg-gradient-to-br from-primary/10 via-primary/5 to-transparent dark:from-primary/20 dark:via-primary/10">
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
					...
					<div className="text-center mt-12">
						...
						<p className="mt-4 max-w-2xl mx-auto text-textSecondary">
							Orchestrate multiple AI agents through a five-stage process—Idea,
							Critique, Combination, Formalization, and Organization—to deliver
