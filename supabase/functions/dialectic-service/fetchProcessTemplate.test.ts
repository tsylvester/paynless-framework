...
describe("fetchProcessTemplate", () => {
  ...
  it("should successfully fetch a full process template with stages and transitions", async () => {
    ...
    const mockStagesData: DialecticStage[] = [
      { id: 'stage-a', display_name: 'Stage A', slug: 'stage-a', description: null, default_system_prompt_id: null, expected_output_template_ids: [], active_recipe_instance_id: null, recipe_template_id: null, created_at: '', minimum_balance: 0 },
      { id: 'stage-b', display_name: 'Stage B', slug: 'stage-b', description: null, default_system_prompt_id: null, expected_output_template_ids: [], active_recipe_instance_id: null, recipe_template_id: null, created_at: '', minimum_balance: 0 },
      { id: 'stage-c', display_name: 'Stage C', slug: 'stage-c', description: null, default_system_prompt_id: null, expected_output_template_ids: [], active_recipe_instance_id: null, recipe_template_id: null, created_at: '', minimum_balance: 0 },
    ];
   ...
   it("should return a template with only a starting stage if no transitions exist", async () => {
    ...
    const mockStageData: DialecticStage[] = [{ id: 'stage-start', display_name: 'Start', slug: 'start', description: null, default_system_prompt_id: null, expected_output_template_ids: [], active_recipe_instance_id: null, recipe_template_id: null, created_at: '', minimum_balance: 0 }];
