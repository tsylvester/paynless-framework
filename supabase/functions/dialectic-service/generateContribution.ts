...
export async function generateThesisContributions(
    dbClient: SupabaseClient<Database>,
    payload: GenerateThesisContributionsPayload,
    authToken: string, 
    partialDeps?: Partial<GenerateContributionsDeps> 
  ): Promise<{ success: boolean; data?: GenerateThesisContributionsSuccessResponse; error?: { message: string; status?: number; details?: string; code?: string } }> {
