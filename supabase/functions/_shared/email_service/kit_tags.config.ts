...
export const kitTagMap: Record<string, KitTagConfig> = {
  vibecoder: {
    tagId: 'PLACEHOLDER_VIBECODER_TAG_ID', // TODO: Replace with actual Kit tag ID
    description: 'Vibe Coders - developers who care about aesthetic and feel'
  },
  indiehacker: {
    tagId: 'PLACEHOLDER_INDIEHACKER_TAG_ID', // TODO: Replace with actual Kit tag ID
    description: 'Indie Hackers - solo developers building their own products'
  },
  startup: {
    tagId: 'PLACEHOLDER_STARTUP_TAG_ID', // TODO: Replace with actual Kit tag ID
    description: 'Startups - teams building new products from scratch'
  },
  agency: {
    tagId: 'PLACEHOLDER_AGENCY_TAG_ID', // TODO: Replace with actual Kit tag ID
    description: 'Agencies - teams building products for clients'
  },
  pricing: {
    tagId: 'PLACEHOLDER_PRICING_TAG_ID', // TODO: Replace with actual Kit tag ID
  ...
  legacy_user: {
    tagId: 'PLACEHOLDER_LEGACY_USER_TAG_ID', // TODO: Replace with actual Kit tag ID
    description: 'Users who signed up before newsletter system was implemented'
  },
  no_explicit_opt_in: {
    tagId: 'PLACEHOLDER_NO_EXPLICIT_OPT_IN_TAG_ID', // TODO: Replace with actual Kit tag ID
...
export const SEGMENT_SLUGS: SegmentSlug[] = ['vibecoder', 'indiehacker', 'startup', 'agency'];
