        ...
        const mockDbResponse: DatabaseRecipeSteps = {
            ...
            dialectic_stage_recipe_instances: [{
                ...
                dialectic_stage_recipe_steps: [{
                    ...
                    outputs_required: '{"system_materials":{"agent_notes_to_self":"summary of which milestones are detailed in this iteration and why","input_artifacts_summary":"TRD sections used, Master Plan phase/milestone references","stage_rationale":"explain ordering, TDD emphasis, and how checklist conforms to style guide","progress_update":"summarize completed vs remaining milestones; denote updated statuses in Master Plan","generation_limits":{"max_steps":200,"target_steps":"120-180","max_output_lines":"600-800"},"document_order":["actionable_checklist","updated_master_plan","advisor_recommendations"],"current_document":"actionable_checklist","exhaustiveness_requirement":"extreme detail; no summaries; each step includes inputs, outputs, validation; follow the style guide exactly","validation_checkpoint":["checklist uses style guide (status, numbering, labels)","steps are atomic and testable","dependency ordering enforced","coverage aligns to milestone acceptance criteria"],"quality_standards":["TDD sequence present","no missing dependencies","no speculative steps beyond selected milestones","clear file-by-file prompts"],"iteration_metadata":{"iteration_number":"<populate_at_runtime>","previous_checklist_present":"<derived_from_storage>","previous_master_plan_present":"<derived_from_storage>"},"milestones_to_detail":[],"status_rules":{"completed":"[✅]","in_progress":"[🚧]","unstarted":"[ ]"}},"header_context_artifact":{"type":"header_context","document_key":"header_context","artifact_class":"header_context","file_type":"json"},"context_for_documents":[{"document_key":"actionable_checklist","content_to_include":{"milestone_ids":["<list the next milestone(s) to detail from the master_plan and milestone_schema>"],"elaboration_instruction":"For each milestone node from the milestone_schema, expand into a full Example Checklist node. Elaborate in dependency order. Use continuation if limits reached.","node_skeleton":{"path":"<path/function>","objective":"<objective>","role":"<role>","module":"<module>","deps":"<deps>","context_slice":"<context_slice>","interface":"<interface>","type_guard_tests":"<type_guard_tests>","guards":"<guards>","unit_tests":"<unit_tests>","construction":"<construction>","source":"<source>","provides":"<provides>","mocks":"<mocks>","integration_tests":"<integration_tests>","directionality":"<directionality>","requirements":"<requirements>","commit":"<commit>"}}},{"document_key":"updated_master_plan","content_to_include":{"phases":[{"milestones":[{"id":"","title":"","status":"","objective":"","deps":[],"provides":[],"directionality":"","requirements":[],"iteration_delta":""}]}],"preserve_completed":true,"set_in_progress":"[🚧]","future_status":"[ ]","capture_iteration_delta":true}},{"document_key":"advisor_recommendations","content_to_include":{"require_comparison_matrix":true,"summarize_tradeoffs":true,"capture_final_recommendation":true,"tie_breaker_guidance":true}}]}',
                    parallel_group: null,
                    branch_key: null,
                    execution_order: 1,
        ...
        const mockDbResponse: DatabaseRecipeSteps = {
            ...
            dialectic_stage_recipe_instances: [{
                ...
                dialectic_stage_recipe_steps: [{
                    ...
                    outputs_required: '{"documents":[{"document_key":"actionable_checklist","template_filename":"paralysis_actionable_checklist.md","artifact_class":"rendered_document","file_type":"markdown"}],"assembled_json":[{"document_key":"actionable_checklist","artifact_class":"assembled_document_json","fields":["nodes[].path","nodes[].objective","nodes[].role","nodes[].module","nodes[].deps","nodes[].context_slice","nodes[].interface","nodes[].type_guard_tests","nodes[].guards","nodes[].unit_tests","nodes[].construction","nodes[].source","nodes[].provides","nodes[].mocks","nodes[].integration_tests","nodes[].directionality","nodes[].requirements","nodes[].commit"]}],"files_to_generate":[{"template_filename":"paralysis_actionable_checklist.md","from_document_key":"actionable_checklist"}]}',
                    parallel_group: 2,
                    branch_key: null,
                    execution_order: 2,
                    created_at: '2025-11-06T00:00:00.000Z',
