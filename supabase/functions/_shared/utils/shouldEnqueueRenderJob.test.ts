...
import { createMockSupabaseClient, type MockSupabaseClientSetup, type MockQueryBuilderState } from '../supabase.mock.ts';
...
describe('shouldEnqueueRenderJob', () => {
    ...
    it('should return false for header_context output type', async () => {
        ...
        const deps: ShouldEnqueueRenderJobDeps = { dbClient: client };
    ...
    it('should return true for markdown document output type', async () => {
        const mockStage: Tables<'dialectic_stages'> = {
            id: 'stage-1',
            slug: 'thesis',
            display_name: 'Thesis',
    ...
    it('should return false when recipe steps are missing', async () => {
        const mockStage: Tables<'dialectic_stages'> = {
            id: 'stage-1',
            slug: 'thesis',
            display_name: 'Thesis',
