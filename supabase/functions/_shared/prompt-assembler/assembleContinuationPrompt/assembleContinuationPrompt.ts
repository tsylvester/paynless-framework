...
import { GatherContinuationInputsPayload } from "../gatherContinuationInputs/gatherContinuationInputs.interface.ts";
import { AssembleContinuationPromptDeps, AssembledPrompt } from "../prompt-assembler.interface.ts";
...
export async function assembleContinuationPrompt(
  ...
  const messages = gatherResult.messages;
