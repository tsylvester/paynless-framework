-- Fix stage auto-advance: Part 3 of handle_job_completion must only set status = {stage}_completed.
-- Do NOT update current_stage_id; stage advancement is user-initiated only (submitStageResponses).
-- Restores behavior from 20260129201333_stage_completed.sql that was overwritten by 20260303033737.
