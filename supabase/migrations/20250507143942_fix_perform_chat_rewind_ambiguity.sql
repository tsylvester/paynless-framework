...
BEGIN
    ...
    SELECT public.chat_messages.created_at INTO v_rewind_point_created_at
    FROM public.chat_messages
    WHERE public.chat_messages.id = p_rewind_from_message_id AND public.chat_messages.chat_id = p_chat_id;
    ...
    WHERE public.chat_messages.chat_id = p_chat_id AND public.chat_messages.created_at > v_rewind_point_created_at;
