-- CREATE OR REPLACE the function with the corrected signature,
-- allowing p_model_id to be nullable by providing a default.
...
BEGIN
    ...
    -- Note the mapping from parameters to the table columns.
