-- Migration: Rename system_materials.executive_summary to system_materials.agent_notes_to_self
-- 
...
--
-- This migration updates all PLAN recipe steps to use agent_notes_to_self in 
...
SET outputs_required = 
    jsonb_set(
        ...
        '{system_materials,agent_notes_to_self}',
        outputs_required->'system_materials'->'executive_summary'
    )
WHERE job_type = 'PLAN'
